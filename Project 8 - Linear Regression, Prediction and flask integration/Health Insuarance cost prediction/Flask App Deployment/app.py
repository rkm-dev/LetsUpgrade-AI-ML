...
app = Flask(__name__)
model = pickle.load(open('Prediction_model/model.pkl', 'rb'))
...
def predict():
    ...
    return render_template('index.html', prediction_text='Predicted cost value of health insaurance will be $ {}'.format(output))
